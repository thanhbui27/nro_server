...
//                    BanDoKhoBauService.gI().openBanDoKhoBau(player, (byte) );
    ...
    public void createFormDoiTVSangRuby(Player pl) {
        try {
            createForm(pl, DOI_VANG_SANG_RUBY, "Số lượng thỏi vàng bạn đang có: " + InventoryServiceNew.gI().findItem(pl.inventory.itemsBag, 457).quantity + "\nNhập số thỏi vàng muốn đổi (1 thỏi vàng = 20 ruby):", new SubInput("Số thỏi vàng muốn đổi", ANY));
